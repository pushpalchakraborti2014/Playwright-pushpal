...
test.describe('Test Scenario 1: Simple Form Demo - LambdaTest Cloud (2 Browsers)', () => {
    ...
    test('Run on Chrome - LambdaTest Cloud', async () => {
        ...
        try {
            ...
            await test.step('Step 3: Enter message', async () => {
                ...
                const messageInput = page.locator('input#user-message[type="text"]').first();
    ...
    test('Run on Microsoft Edge - LambdaTest Cloud', async () => {
        ...
        const capabilities = getCapabilities('MicrosoftEdge', 'Scenario 1 - Simple Form Demo - Edge');
        const wsEndpoint = `wss://cdp.lambdatest.com/playwright?capabilities=${encodeURIComponent(JSON.stringify(capabilities))}`;
        ...
        try {
            ...
            await test.step('Step 1: Open TestMu AI Selenium Playground', async () => {
                console.log('🚀 Starting Test Scenario 1 on LambdaTest Cloud (Edge)');
                await page.goto('https://www.testmuai.com/selenium-playground/', {
                    waitUntil: 'domcontentloaded',
                    timeout: 60000
                });
